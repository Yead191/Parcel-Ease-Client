...
const ServicesSection = () => {
    ...
    return (
        <section className="bg-white py-12 px-6 lg:px-16" ref={ref}>
            <div className="container mx-auto text-center">
                ...
                >
                    {/* Card 1 */}
                    <div className="p-6 bg-[#F0EFE6] rounded-lg shadow hover:shadow-lg transition flex flex-col items-center">
